<div class="myContent">
    <form action="" method="POST">
        ...
        if (isset($_GET['tournament_mode']) && ($_GET['tournament_mode'] == "0" || $_GET['tournament_mode'] == "2" )) {
            ?>
        ...
        if (isset($_GET['tournament_mode']) && ($_GET['tournament_mode'] == "1" || $_GET['tournament_mode'] == "2" )) {
            ?>
            <div class="myTournament2">
                <?php
